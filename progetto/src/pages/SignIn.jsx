...
function SignIn() {
  ...
  async function OnLogInClicked(e) {
    ...
    try {
      ...
      setErrorMessage('Nome utente o password non valida. Riprova.');
    }
...
>>>>>>> modificheServizi
              ...
              <button
                type="submit"
                className="w-full block bg-customBlue hover:bg-customGreen focus:bg-customGreen text-white font-semibold rounded-lg px-4 py-3 mt-6"
