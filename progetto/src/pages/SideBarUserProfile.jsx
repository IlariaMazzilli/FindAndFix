      ...
      <>
        <div className="container">
          <div className="side-bar">
            <div>
              <div className="inline-flex size-100 items-center justify-center">
                <span className="grid size-100 place-content-center rounded-lg bg-gray-100 text-M text-black-600">
                  PROFILO UTENTE
                </span>
              </div>
              ...
              <div className="border-t border-gray-100">
                <div className="px-2">
                  <ul className="space-y-1 border-t border-gray-100 pt-4">
                    <div className="py-3">
                      <li>
                        <Link to="/" className="t group relative flex justify-flex-start rounded bg-blue-50 px-2 py-1.5 text-blue-700">
                    ...
                    <li>
                      <Link to="/servizi" className="group relative flex justify-start rounded px-2 py-1.5 text-gray-500 hover:bg-gray-50 hover:text-gray-700">
          ...
          <Routes>
            ...
            <Route path="/servizi" element={<Servizi />} /> {/* Assicurati di fornire il componente per la pagina dei servizi */}
{/* aggiungi rotte */}
          </Routes>
