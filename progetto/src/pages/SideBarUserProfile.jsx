    ...
    <>
      <div className="container">
        <div className="sideBar">
          <div className="flex h-screen w-100 flex-col justify-between border-e bg-white">
            <div>
                  ...
                  <ul className="space-y-1 border-t border-gray-100 pt-4">
                    <div className="py-3">
                      <li>
                        <a
                          href="#"
                          className="t group relative flex justify-flex-start rounded bg-blue-50 px-2 py-1.5 text-blue-700"
                        >
                          <svg
