                        ...
                        <div className="bg-gray-200 p-6 rounded-lg">
                            <form onSubmit={handleSubmit} className="mt-2 space-y-4">
                                ...
                                <div className='w-full flex justify-center'>
                                    <button type='button' className="text-white bg-customGreen transition hover:scale-110 font-semibold rounded-md text-sm px-4 py-3 flex items-center justify-center w-fit" onClick={thankyouPage}>
