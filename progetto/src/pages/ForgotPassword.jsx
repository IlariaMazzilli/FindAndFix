            ...
            <form className="mt-4 space-y-4 lg:mt-5 md:space-y-5" action="#">
              ...
              <div className="flex items-start">
                ...
                <div className="ml-3 text-sm">
                  <label htmlFor="newsletter" className="font-light text-gray-500 dark:text-gray-300">Accetto i <a className="font-medium text-primary-600 hover:underline dark:text-primary-500" href="#">Termini e Condizioni</a></label>
                </div>
              </div>
              <button type="submit" className="w-full text-white bg-customBlue bg-primary-600 hover:bg-primary-700 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">Reset password</button>
            </form>
          </div>
        </div>
      </section>
