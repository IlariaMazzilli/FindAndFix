...
import BannerPro from '../assets/Banner-Pro.png'
  ...
  <div className="lg:grid lg:min-h-screen lg:grid-cols-12">
    ...
    >
      <div className="max-w-xl lg:max-w-3xl">
        ...
        Stai per registrarti come <strong>professionista </strong>del nostro sito. <br/>
        Completa tutti i campi ed inizia a guadagnare tramite i nostri servizi.
        ...
        <form action="#" className="mt-8 grid grid-cols-6 gap-6">
          ...
          <div className="col-span-6 sm:flex sm:items-center sm:gap-4">
            ...
            <p className="mt-4 text-sm text-gray-500 sm:mt-0">
              Sei un cliente ?
              <a href="#" className="text-gray-700 underline"> Registrati come cliente</a>.
            </p>
          </div>
        </form>
      </div>
