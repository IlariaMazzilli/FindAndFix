    ...
    <div className="bg-white min-w-1xl flex flex-col rounded-xl shadow-lg max-[768px]:shadow-none">
      ...
      <div className=" w-full flex flex-col items-center">
        ...
        <div className="w-3/4 flex flex-col">
          <textarea rows="3" className="p-4 text-gray-500 rounded-xl resize-none shadow-lg">Lasciaci una recensione, se ti va !</textarea>
          <button className="py-3 my-8 text-lg bg-gradient-to-r transition from-customBlue to-customGreen rounded-xl text-white hover:scale-110">Posta recensione</button>
        </div>
      </div>
