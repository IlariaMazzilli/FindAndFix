...
function Navbar() {
  ...
  return (
    <div>
      <header className="bg-white p-4 mobile:p-2 fixed w-full z-10">
        <div className="mx-auto max-w-screen-xl px-4  large:px-8 mobile:px-0">
          <div className="flex h-16 items-center justify-between">
            <div className="md:flex md:items-center md:gap-12">
              <a className="block text-teal-600" href="#">
                <span className="sr-only">Home</span>
                <img src={logo} className='w-20 h-16 mobile:w-10 mobile:h-8' alt='Find & Fix' />
              </a>
            </div>
            ...
            <div className="flex justify-around w-70 mobile:w-10 md:w-10">
              <div className="mobile:hidden md:hidden">
                <a
                  className="rounded-md mx-4 bg-customBlue px-5 py-2.5 text-mobile font-medium text-white shadow hover:bg-customGreen mobile:p-2"
                  href="#"
                >
                  LOGIN
                </a>
                ...
                <a
                  className="rounded-md bg-customBlue px-5 py-2.5 text-mobile font-medium text-white hover:bg-customGreen "
                  href="#"
                >
                  REGISTRATI
                </a>
                ...
                <a
                  className="rounded-md ml-4 bg-customBlue px-5 py-2.5 text-mobile font-medium text-white hover:bg-customGreen "
                  href="#"
                >
                  REGISTRATI COME PRO
                </a>
