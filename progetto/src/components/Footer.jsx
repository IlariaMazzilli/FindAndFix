...
import logo from '../images/FIND__FIX.svg'
...
function Footer() {
    ...
    return (
        <footer id='footer'>
            <div className="bg-gray-50 py-4 text-customBlue pl-10">
                <div className="container px-4 mx-auto">
                    <div className="-mx-4 flex flex-wrap justify-between">
                        <div className="px-4 my-4 w-full xl:w-48">
                        ...
                        <div className="px-4 my-4 w-full sm:w-auto">
                            <div>
                                <h2 className="inline-block text-2xl pb-4 mb-4 border-b-4 border-blue-600">Azienda</h2>
                            </div>
                            <ul className="leading-8">
                                <li><Link to="/chiSiamo" className="hover:text-blue-400">Chi siamo</Link></li>
                                <li><Link to="/termsAndConditions" className="hover:text-blue-400">Termini e condizioni</Link></li>
                        ...
                        <div className="px-4 my-4 w-full sm:w-auto">
                            <div>
                                <h2 className="inline-block text-2xl pb-4 mb-4 border-b-4 border-blue-600">Contatti</h2>
                            </div>
                            <ul className="leading-8">
                                <li><a href="#" className="hover:text-blue-400">findandfix@info.com</a></li>
                                <li><a href="#" className="hover:text-blue-400">Piazza della luna 14, Domodossola, VB</a></li>

                            </ul>
                        </div>
                        <div className="px-4 my-4 w-full sm:w-auto xl:w-1/5">
                            <div>
                                <h2 className="inline-block text-2xl pb-4 mb-4 border-b-4 border-blue-600">Seguici sui socials</h2>
                            </div>
            ...
            <div className="bg-customBlue py-4 text-gray-100">
                <div className="container mx-auto px-4">
                    <div className="-mx-4 flex flex-wrap justify-between">
                        <div className="px-4 w-full text-center sm:w-auto sm:text-left">
                            {`Copyright © ${year} 
            
             Find & Fix. All Rights Reserved.`}
