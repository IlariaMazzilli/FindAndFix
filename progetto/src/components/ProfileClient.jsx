        ...
        <div className="bg-white rounded-lg shadow-xl pb-8 max-[768px]:shadow-none">
          <div className="flex flex-col items-center mt-4">
            ...
            <div className="flex items-center space-x-2 mt-2">
              <p className="text-2xl">Serena Giacchini</p>
            ...
            <p className="text-sm text-gray-500">Napoli, NA</p>
          </div>
            ...
            <div className="flex-1 bg-white rounded-lg shadow-xl max-[768px]:p-0 p-8 max-[768px]:shadow-none">
              ...
              <ul className="mt-2 text-gray-700">
                <li className="flex border-y py-2">
                  ...
                  <span className="text-gray-700 flex-1 text-center">Serena Giacchini</span>
                </li>
                <li className="flex border-b py-2">
                  <span className="font-bold w-24 text-customBlue">Data di nascita:</span>
                  <span className="text-gray-700 flex-1 text-center">24 luglio, 1991</span>
                </li>
                <li className="flex border-b py-2">
